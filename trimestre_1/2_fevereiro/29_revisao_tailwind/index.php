...
<body class="h-[-webkit-fill-available] h-[-moz-available] dark:bg-neutral-900">
    ...
    <div class="flex flex-col h-screen w-6/12 mx-auto">
        <h1 class="font-bold text-4xl py-10 dark:text-zinc-50">Exercício com TailwindCSS</h1>
            ...
            <form action="bem_vindo.php" class="flex flex-col w-[-moz-available] w-[-webkit-fill-available] gap-y-2" method="POST">
                <div class="flex gap-x-8 gap-y-8">
                    <div class="flex flex-col justify-center w-[-webkit-fill-available] w-[-moz-available]">
                        ...
                        <input type="text" id="nome" name="nome" class="rounded-md px-2 py-1 border border-gray-300 outline-none focus:ring focus:ring-blue-500 w-[-webkit-fill-available] w-[-moz-available] 
                            dark:bg-neutral-800 dark:border-none">
                    </div>

                    <div class="flex flex-col justify-center w-[-webkit-fill-available] w-[-moz-available]">
                        <label for="sobrenome" class="dark:text-zinc-50">Sobrenome</label>
                        <input type="text" id="sobrenome" name="sobrenome" class="rounded-md px-2 py-1 border border-gray-300 outline-none focus:ring focus:ring-blue-500 w-[-webkit-fill-available] w-[-moz-available] 
                            dark:bg-neutral-800 dark:border-none">
                    </div>
                </div>
